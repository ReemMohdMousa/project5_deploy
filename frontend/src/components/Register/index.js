...
const Register = () => {
    ...
    if (firstName && lastName && email && password && age && repassword) {
      if (repassword === password) {
        if (!document.getElementById("agree").checked) {
          ...
          axios
            .post("https://project5-deploy.onrender.com/users/register", {
              firstName,
              lastName,
              email,
              password,
  ...
  const loginGoogle = (result) => {
    ...
    axios
      .post("https://project5-deploy.onrender.com/users/google", {
        credential,
        clientId,
      })
      .then((res) => {
        ...
        axios
          ...
          .catch((err) => {
            if (err.response.data.message === "The email already exists") {
              axios
                .post("https://project5-deploy.onrender.com/users/login", {
                  email,
                  password: fakePass,
                })
                .then((result) => {
