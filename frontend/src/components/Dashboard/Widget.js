...
const Widget = ({ type }) => {
  ...
  switch (type) {
    case "user":
      axios
        .get(`https://project5-deploy.onrender.com/count/user`)
        .then((result) => {
    ...
    case "posts":
      axios
        .get(`https://project5-deploy.onrender.com/count/post`)
        .then((result) => {
    ...
    case "likes":
      axios
        .get(`https://project5-deploy.onrender.com/count/like`)
        .then((result) => {
    ...
    case "newUser":
      axios
        .get(`https://project5-deploy.onrender.com/count/newuser/details`)
        .then((result) => {
